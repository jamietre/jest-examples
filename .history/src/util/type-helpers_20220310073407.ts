...
export function assertIsValidDate(
  ...
  if (!(value instanceof Date) || !isValidDate(value)) {
    throw new ValidationError(
      errorMessage || "The value must be a Date object."
    );
  }
}
...
export function assertIsString(
  ...
  if (!(typeof value === "string")) {
    throw new ValidationError(errorMessage || "The value must be a string.");
  }
}
...
export function assertIsNumber(
  ...
  if (!isNumber(value)) {
    throw new ValidationError(errorMessage ?? "The value must be a number");
  }
}
...
export function assertIsBoolean(
  ...
  if (typeof value !== "boolean") {
    throw new ValidationError(errorMessage ?? "The value must be a boolean");
  }
}
...
export function assertIsArray<T>(
  ...
  if (!Array.isArray(value)) {
    throw new ValidationError(errorMessage ?? "The value must be an array");
  }
}
...
export function assertIsTrue(
  ...
  if (!value) {
    throw new ValidationError(errorMessage || "The value must be true");
  }
}

export function assertNever(value: never, errorMessage?: string): never {
  throw new ValidationError(
    errorMessage || `Unexpected value: ${String(value)}`
  );
}
